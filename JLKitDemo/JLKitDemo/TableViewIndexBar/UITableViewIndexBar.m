...
@implementation UITableViewIndexBar
...
- (instancetype)initWith:(UITableView *)view andTitles:(NSArray *)titleArray{
    ...
    if (self) {
        ...
        selectedBgLabel.backgroundColor = [UIColor colorWithRed:175/255.0 green:227/255.0 blue:110/255.0 alpha:1.0f];
...
- (CGRect)preCalculateParameterWithSuperView:(UITableView *)view count:(NSUInteger)count{
    ...
    CGFloat width  = 32;
    CGFloat preheight = CGRectGetHeight(view.frame) - CGRectGetMinY(view.frame) - view.contentInset.top - view.contentInset.bottom - 80;
