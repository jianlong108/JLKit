...
@interface MTIndexViewConfiguration ()

@property (nonatomic, assign) MTIndexViewStyle indexViewStyle;  // 索引元素之间间隔距离

@end

@implementation MTIndexViewConfiguration

@synthesize indexViewStyle = _indexViewStyle;

+ (instancetype)configuration
{
    return [self configurationWithIndexViewStyle:MTIndexViewStyleDefault];
}
...
{
    MTIndexViewConfiguration *configuration = [self new];
