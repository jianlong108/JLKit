...
{
    CGFloat safeTopInset = (UIApplication.sharedApplication.delegate.window ?: UIApplication.sharedApplication.keyWindow).safeAreaInsets.top;
    return CGRectGetHeight([UIApplication sharedApplication].statusBarFrame) + safeTopInset;
}
